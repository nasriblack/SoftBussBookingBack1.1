  ...
  describe("should get all Reservation For admin", () => {
    ...
    test("should throw an error when the user is not an admin", async () => {
      // Test implementation
      {
        // Test implementation
        let tokenAdmin =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..49VQi5pJoKiYtfwTKCym_9S6Lqcv3mzpb6HCxzgCk_c";
        // Test implementation
